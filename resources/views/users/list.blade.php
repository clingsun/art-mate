    ...
    module.exports = {
        data: function() {
            return {
                ...
                col_list: [
                    ...
                    {title:'is_real_name', key:'is_real_name'},
                    {title:'balance', key:'balance'},
                    {title:'nick_name', key:'nick_name'},
                    {title:'invite_code', key:'invite_code'},
        ...
        methods: {
            tableData: function() {
                ...
                this.axios
                    .post('/api/users/list'+pageStr,JSON.stringify(search_list))
                    .then(response=>{
            ...
            invokeEdit: function(row) {
                this.$router.push({path:'/users/edit',query:{id:row.id}})
            },
            ...
            invokeConfirmDelete: function(row) {
                this.axios
                    .post('/api/users/delete',JSON.stringify({'id':row.id}))
                    .then(response=>{
            ...
            invokeConfirmBatchDelete: function() {
                this.axios
                    .post('/api/users/batch_delete',JSON.stringify({'ids':this.batchDeleteModalData}))
                    .then(response=>{
