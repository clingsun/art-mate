    ...
    module.exports = {
        data: function() {
            return {
                ...
                col_list: [
                    ...
                    {title:'order_price', key:'order_price'},
                    {title:'t_id', key:'t_id'},
        ...
        methods: {
            tableData: function() {
                ...
                this.axios
                    .post('/api/orderss/list'+pageStr,JSON.stringify(search_list))
                    .then(response=>{
            ...
            invokeDetail: function(row) {
                ...
                this.$router.push({path:'/orderss/detail',query:{id:row.id}})
            },
            invokeEdit: function(row) {
                this.$router.push({path:'/orderss/edit',query:{id:row.id}})
            },
            invokeCreate: function() {
                this.$router.push({path:'/orderss/create'})
            },
            ...
            invokeConfirmDelete: function(row) {
                this.axios
                    .post('/api/orderss/delete',JSON.stringify({'id':row.id}))
                    .then(response=>{
            ...
            invokeConfirmBatchDelete: function() {
                this.axios
                    .post('/api/orderss/batch_delete',JSON.stringify({'ids':this.batchDeleteModalData}))
                    .then(response=>{
