<template>
    <div class="layout">
        <i-breadcrumb :style="{margin: '24px 24px'}">
            <i-breadcrumb-item>treasures</i-breadcrumb-item>
    ...
    module.exports = {
        data: function() {
            return {
                ...
                col_list: [
                    ...
                    {title:'brand_party', key:'brand_party'},
                    {title:'chain_part', key:'chain_part'},
        ...
        methods: {
            tableData: function() {
                ...
                this.axios
                    .post('/api/treasures/list'+pageStr,JSON.stringify(search_list))
                    .then(response=>{
            ...
            invokeDetail: function(row) {
                ...
                this.$router.push({path:'/treasures/detail',query:{id:row.id}})
            },
            invokeEdit: function(row) {
                this.$router.push({path:'/treasures/edit',query:{id:row.id}})
            },
            invokeCreate: function() {
                this.$router.push({path:'/treasures/create'})
            },
            ...
            invokeConfirmDelete: function(row) {
                this.axios
                    .post('/api/treasures/delete',JSON.stringify({'id':row.id}))
                    .then(response=>{
            ...
            invokeConfirmBatchDelete: function() {
                this.axios
                    .post('/api/treasures/batch_delete',JSON.stringify({'ids':this.batchDeleteModalData}))
                    .then(response=>{
